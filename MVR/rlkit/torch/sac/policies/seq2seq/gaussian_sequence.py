"""
The regular tanh gaussian policy but can use it in the sequential RL algs.
...
class SequentialTanhGaussianPolicy(Mlp, TorchStochasticSequencePolicy):
...
class SequentialTanhGaussianPolicyAdapter(TorchStochasticPolicy):
    def __init__(
        self,
