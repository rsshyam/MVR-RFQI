sh scripts/run_seq_env_script.sh --env 'Pendulum-v1' --type 'rfqi' --data_eps 0.3 --rho 0.1 --gendata_pol 'sac' --nsamples 60 --max_trn_steps 50000 --batch_size 100 --comment '50000-100' 
