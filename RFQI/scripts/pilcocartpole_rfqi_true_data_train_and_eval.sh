sh scripts/run_seq_env_script.sh --env 'pilcocartpole-v0' --type 'rfqi' --data_eps 0.3 --rho 0.3 --gendata_pol 'mpc' --nsamples 0 --max_trn_steps 5000 --batch_size 100 --comment '5000-100' 
