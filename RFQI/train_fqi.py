...
if __name__ == "__main__":
    ...
    print(args.d4rl,args.mixed,args.dtalrnt)
    if args.d4rl == 'False' and args.mixed == 'False':
        if args.dtalrnt == 'True':
            ...
            save_path = f'FQI_{args.env}_dataeps{args.data_eps}_datapol{args.gendata_pol}_nsamples_{args.nsamples}_{args.comment}'
        else:
