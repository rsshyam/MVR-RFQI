...
if __name__ == "__main__":
    ...
    #print('_qpos_spring', model.qpos_spring)
    ...
    if args.d4rl == 'False' and args.mixed == 'False':
        if args.dtalrnt == 'True':
            data_path = f'offline_data/{args.env}_{args.gendata_pol}_e{args.data_eps}_nsamples_{args.nsamples}'
            save_path = f'RFQI_{args.env}_rho{args.rho}_dataeps{args.data_eps}_datapol{args.gendata_pol}_nsamples_{args.nsamples}_{args.comment}'
        else:
